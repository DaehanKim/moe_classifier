...
if __name__ == "__main__":
    ...
    args = TrainingArguments(output_dir = "./moe_output", remove_unused_columns=False,
                            evaluation_strategy="steps", logging_strategy="steps", logging_steps=1, eval_steps=5 if os.environ.get("DEBUG", "false") == "true" else 50, 
                            max_steps=1000,
                            per_device_train_batch_size = 128,
                            per_device_eval_batch_size = 256,
                            learning_rate=float(os.environ.get("LR", 2e-4)),
                            report_to="wandb",
                            run_name=os.environ.get("RUN_NAME","moe_model"),
